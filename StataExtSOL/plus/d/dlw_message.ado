...
program define dlw_message
	...
	else if `error'==403 noi dis "{err}Error code 403 - Not an authorized user to download"
	...
	else if `error'==671 noi dis "{err}Error code 671 - Authentication failed. Invalid email format. Please provide a valid email ID and token"					
